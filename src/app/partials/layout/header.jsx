...
export function Header() {
    ...
    return (
        <header ref={textRef} className={`text-white ${navBg ? 'bg-white shadow' : ''} duration-100 transition-all z-20 opacity-0 fixed w-full h-20 lg:h-25 px-5 lg:px-10 xl:px-16 py-1 items-center justify-between flex`}>
            <div className="flex-1/2 xl:flex-1/5 p-1 font-[family-name:var(--font-kumbh-sans)]">
